            ...
            <div class="card-underline">
                ...
                <div class="card-body">
                        ...
                        <div class="col-sm-12">
                            {{-- <div class="form-group">
                                <input type="text" name="name" class="form-control" required
                                       value="{{ old('name', isset($state->name) ? $state->name : '') }}"/>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="">
                                    <input class="form-control" type="text" required name="title" value="{{ old('title', isset($state->title) ? $state->title : '') }}" placeholder="Enter Title">
                                </div>
                            </div>
                            @error('title')
                    ...
                    <div class="row mt-2 justify-content-center">
                        <div class="form-group">
                            <div>
                                <a class="btn btn-light waves-effect ml-1" href="{{ route('state.index') }}">
